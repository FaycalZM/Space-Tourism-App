...
const Technology = () => {
  ...
  return (
    <div className='py-6 desktop:pl-2 relative'>
      <p className='desktop:text-heading-5 text-[20px] font-barlow-condensed text-white desktop:tracking-lg tracking-[3.375px] desktop:mt-0 tablet:mt-12 mt-16 tablet:ml-8 tablet:text-left text-center uppercase'>
      ...
      <div
        ...
        className='bg-[image:var(--tablet-technology-image-url)] bg-cover bg-center tablet:h-[32.5vh] h-[25vh] mt-10 desktop:hidden block'></div>
