...
const Destination = () => {
  ...
  return (
    <div className='py-6 desktop:px-4 px-8'>
      <p className='page-title desktop:text-heading-5 tablet:text-[20px] text-[18px] font-barlow-condensed text-white desktop:tracking-lg tablet:tracking-[3.375px] tracking-md desktop:mt-0 tablet:mt-12 mt-16 uppercase tablet:text-left text-center'><span className='opacity-25 tablet:mr-7 mr-4 font-bold'>01</span>pick your destination</p>
      <div className='flex desktop:flex-row flex-col desktop:text-left text-center pt-2 justify-around items-center '>
        <img
          className='destination-img desktop:w-1/3 tablet:w-[38.5%] w-3/4 desktop:mt-8 mt-12'
          src={currentDestinationImage}
          alt={`destination_image`} />
        <div className='destination-infos desktop:w-1/3 w-full desktop:mt-0 mt-8'>
